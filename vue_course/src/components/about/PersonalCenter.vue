<template>
    <div class="PersonalCenter { active: isActive }">
        <div class="user">
            ...
            <List size="small">欢迎
                <Badge :text="user.identity" type="success">
                    ...
                    <Button type="primary" style="margin-left:30px" @click="exit">退出</Button>
            </List>
        ...
        <div class="PersonalCenterMenu" style="height:calc(100vh - 110px)">
            <Menu :theme="theme2"   accordion width="320px">
                ...
                <Submenu name="4" v-if="Isidentity">
                    ...
                    <MenuItem name="4-1" to="/about/ModifyingPersonalInformation" exact>编辑我的信息</MenuItem>
                    <MenuItem name="4-2" to="/about/showtable" exact>管理员组</MenuItem>
                ...
                <Submenu name="5" v-if="Isteacher">
                    ...
                    <MenuItem name="5-1"  to="/about/EditInfoTeacher">编辑我的信息</MenuItem>
                    <MenuItem name="5-2" to="/about/TeacherTeaches">我的任课教程</MenuItem>
                </Submenu>
                ...
                <Submenu name="6" v-if="Isstudent">
                    ...
                    <MenuItem name="6-1"  to="/about/EditInfostudent">编辑我的信息</MenuItem>
                    <MenuItem name="6-2"  to="/about/studentscourseselection">选课</MenuItem>
                    <MenuItem name="6-3"  to="/about/StudentTheselectedcourse">已选课程列表</MenuItem>
                </Submenu>
